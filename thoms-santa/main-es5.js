...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppCircleCircleComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var quagga__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! quagga */
    "./node_modules/quagga/dist/quagga.min.js");
    /* harmony import */


    var quagga__WEBPACK_IMPORTED_MODULE_2___default =
    /*#__PURE__*/
    __webpack_require__.n(quagga__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */


    var _content_en__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../content/en */
    "./src/content/en.ts");
    ...
    function () {
      function AppComponent() {
        ...
        this.currentUtterance.voice = window.speechSynthesis.getVoices().find(function (voice) {
        ...
        this.currentUtterance.onend = function () {
          clearInterval(_this.blinkingInterval);
          _this.blink = false;
        };
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngAfterViewInit() {
          ...
          quagga__WEBPACK_IMPORTED_MODULE_2___default.a.onDetected(function (data) {
            data.forEach(function (code) {
              var codeValue = code.codeResult.code;

              if (_content_en__WEBPACK_IMPORTED_MODULE_3__["default"].barcodes[codeValue]) {
                _this2.scanning = false;
                var message = "<h1>".concat(_content_en__WEBPACK_IMPORTED_MODULE_3__["default"].barcodes[codeValue].name, "</h1><p>").concat(_content_en__WEBPACK_IMPORTED_MODULE_3__["default"].barcodes[codeValue].desc, "<p>");

                if (_this2.currentMessage !== message) {
                  _this2.currentMessage = message;

                  _this2.startSpeach();
                }

                _this2.barCodeFound = true;
              }
            });
          });
          this.startSpeach();
        ...
        value: function startSpeach() {
          ...
          this.blinkingInterval = setInterval(function () {
            _this3.blink = !_this3.blink;
          }, Math.random() * 300 + 200);
          setTimeout(function () {
            window.speechSynthesis.speak(_this3.currentUtterance);
          }, 150);
        }
      }, {
        key: "strip",
        value: function strip(message) {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _circle_circle_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _circle_circle_component__WEBPACK_IMPORTED_MODULE_5__["CircleComponent"]],
  ...
  /***/
  function srcAppCircleCircleComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppCircleCircleComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function CircleComponent(elRef) {
      ...
      _createClass(CircleComponent, [{
        ...
        key: "getStyle",
        value: function getStyle(color, size, border, on) {
          var style = {
          ...
          if (border) {
            style.border = "1px solid ".concat(border);
          }

          if (on) {
            style.fontSize = "".concat(size, "px");
            style.boxShadow = "0px 0px .8em .03em ".concat(this.lighterColor);
          }
        ...
        value: function adjust(color, amount) {
          return '#' + color.replace(/^#/, '').replace(/../g, function (colorTemp) {
            return ('0' + Math.min(255, Math.max(0, parseInt(colorTemp, 16) + amount)).toString(16)).substr(-2);
          });
        }
      }, {
        key: "on",
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], CircleComponent.prototype, "color", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], CircleComponent.prototype, "size", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], CircleComponent.prototype, "on", null);
    CircleComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-circle',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./circle.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/circle/circle.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./circle.component.scss */
      "./src/app/circle/circle.component.scss")).default]
    })], CircleComponent);
    /***/
  },
  ...
  /***/
  function srcContentEnTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/gabor.kaloczi/Documents/projects/thoms-santa/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
